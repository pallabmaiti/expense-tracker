...
func clearUserDefaults() {
    UserDefaults(suiteName: userDefaultsTestSuiteName)!.removeObject(forKey: "Expenses")
    UserDefaults(suiteName: userDefaultsTestSuiteName)!.removeObject(forKey: "Incomes")
}

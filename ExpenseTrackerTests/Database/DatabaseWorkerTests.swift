...
struct DatabaseWorkerTests {
    ...
    func fetchAllExpenses_whenNoExpenseSaved_returnsEmptyArray() async throws {
        let fetchedExpenses = try await #require(databaseWorker.fetchExpenses()["data"] as? [[String: Any]])
    ...
    func fetchAllExpenses_whenExpenseSaved_returnsExpenseArray() async throws {
        _ = try await databaseWorker.saveExpense(id: UUID().uuidString, name: "Test Expense", amount: 100.0, date: Date().formattedString(), category: ExpenseTracker.Category.food.rawValue, note: "Weekly grocery shopping")
    ...
    func updateExpense() async throws {
        ...
        _ = try await databaseWorker.updateExpense(id: expenseId, name: "Updated Test Expense", amount: 200.0, date: Date().byAdding(.day, value: -1).formattedString(), category: ExpenseTracker.Category.entertainment.rawValue, note: "Updated Weekly grocery shopping")
            
        let freshFetchedExpenses = try await #require(databaseWorker.fetchExpenses()["data"] as? [[String: Any]])
    ...
    func updateExpenseFailure() async {
        await #expect(throws: ExpenseTrackerError.dataNotFound) {
            _ = try await databaseWorker.updateExpense(id: "some-id", name: "Updated Test Expense", amount: 200.0, date: Date().byAdding(.day, value: -1).formattedString(), category: ExpenseTracker.Category.entertainment.rawValue, note: "Updated Weekly grocery shopping")
        }
    }
    ...
    func deleteExpense() async throws {
        ...
        _ = try await databaseWorker.deleteExpense(id: expenseIdToDelete)
    ...
    func removeAllExpenses() async throws {
        for i in 0..<10 {
            _ = try await databaseWorker.saveExpense(id: UUID().uuidString, name: "Test Expense \(i)", amount: 100.0, date: Date().formattedString(), category: ExpenseTracker.Category.food.rawValue, note: "Note \(i)")
        }
        ...
        _ = try await databaseWorker.deleteAllExpenses()
    ...
    func fetchAllIncomes_whenNoIncomeSaved_returnsEmptyArray() async throws {
        let fetchedIncomes = try await #require(databaseWorker.fetchIncomes()["data"] as? [[String: Any]])
    ...
    func fetchAllIncomes_whenIncomeSaved_returnsExpenseArray() async throws {
        _ = try await databaseWorker.saveIncome(id: UUID().uuidString, amount: 100.0, date: Date().formattedString(), source: ExpenseTracker.Source.salary.rawValue)
    ...
    func updateIncome() async throws {
        ...
        _ = try await databaseWorker.updateIncome(id: incomeId, amount: 200.0, date: Date().byAdding(.day, value: -1).formattedString(), source: ExpenseTracker.Source.business.rawValue)
        
        let freshFetchedIncomes = try await #require(databaseWorker.fetchIncomes()["data"] as? [[String: Any]])
    ...
    func updateIncomeFailure() async throws {
        await #expect(throws: ExpenseTrackerError.dataNotFound) {
            _ = try await databaseWorker.updateIncome(id: "some-id", amount: 200.0, date: Date().byAdding(.day, value: -1).formattedString(), source: ExpenseTracker.Source.business.rawValue)
        }
    }
    ...
    func deleteIncome() async throws {
        ...
        _ = try await databaseWorker.deleteIncome(id: incomeIdToDelete)
    ...
    func removeAllIncomes() async throws {
        ...
        _ = try await databaseWorker.deleteAllIncomes()
